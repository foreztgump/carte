...
Define the durable security-review requirements for Carte package hardening,
including published audit evidence, capability minimality, sandbox boundaries,
GDPR correctness, Tender/PCI scope, and Cloudflare WAF carve-out tracking.
