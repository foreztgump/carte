/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd packages/ai/mcp-wrapper worker-configuration.d.ts` (hash: edd64b62b954d1f2eb3e3880497abaea)
// Runtime types generated with workerd@1.20260504.1 2026-05-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		EM_DASH_PLUGIN_BASE_URL: "http://localhost:8787/_emdash/api/plugins/carte-ai";
	}
}
